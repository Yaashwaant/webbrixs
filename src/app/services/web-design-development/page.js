...
export const metadata = {
  ...
  description: "Webbrixs crafts premium custom websites. Responsive designs, optimized landing pages, and API-driven head-end frameworks.",
};

export default function WebDesignPage() {
  const offerings = [
    { t: "Custom UI/UX", d: "Interfaces crafted entirely from scratch to project your brand's unique character." },
    { t: "Fluid Responsiveness", d: "Pixel-perfect structures designed to run flawlessly across mobile and desktops." },
    { t: "Technical SEO", d: "Maximizing crawl speeds, semantic hierarchy, and metadata configurations." },
    { t: "Headless CMS", d: "Decoupled databases (Sanity, Strapi) allowing editors easy management with zero speed compromises." },
    { t: "Third-Party APIs", d: "Seamless database bridge bindings for analytics, CRM, and automation flows." },
    { t: "Speed Optimization", d: "Minifying script bundles to ensure 95+ Google Lighthouse speed indexes." }
  ];
    ...
    <main className="w-full">
      ...
      <section className="relative min-h-[85vh] flex flex-col justify-center items-center px-6 md:px-20 pt-[140px] pb-12 text-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-4xl mx-auto flex flex-col items-center gap-6">
          ...
          <p className="text-base md:text-lg text-text-secondary leading-relaxed max-w-2xl mt-4">
            We forge immersive, high-performance web experiences. Deep aesthetic focus meets robust, scalable architecture.
          </p>
      ...
      <section className="px-6 md:px-20 py-24 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
        ...
        <div className="flex flex-col justify-between gap-8">
          <div className="glass-panel p-8 rounded-2xl border border-white/5 relative overflow-hidden flex flex-col justify-between h-full">
            <div>
            ...
            <div className="flex flex-wrap gap-2 mt-8">
              {["Custom UI", "Prisma ORM", "NextJS", "Figma Design", "PostgreSQL", "Docker Deploy"].map((badge) => (
                <span key={badge} className="px-3 py-1 rounded bg-white/5 border border-white/10 text-xs text-text-secondary">
                  {badge}
                </span>
              ))}
            </div>

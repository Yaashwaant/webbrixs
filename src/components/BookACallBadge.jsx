  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 pointer-events-auto flex flex-col gap-3 items-end">
      ...
      <a
        ...
        className="flex items-center gap-2 px-5 py-3 rounded-full bg-[#25D366] text-white hover:bg-[#20ba5a] shadow-[0_4px_20px_rgba(37,211,102,0.4)] transition-all duration-300 transform hover:scale-105 active:scale-95 font-semibold text-xs md:text-sm"
      >
        <svg 
